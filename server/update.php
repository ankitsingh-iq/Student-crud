...
if(isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if(empty($nameErr) && empty($emailErr) && empty($phoneErr) && empty($dobErr) && empty($genderErr) &&
        ...
        $stmt = $conn->prepare("UPDATE students SET full_name= :full_name, email = :email, phone = :phone,
            dob = :dob, gender = :gender, address = :address,
            pincode = :pin, country = :country, state = :state,
            city = :city, documents = :doc WHERE id=:id");
...
<div class="container">
    <div class="card shadow-lg">
        ...
        <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="email" class="form-control" id="email" name="email"
                        value="<?= $res->email; ?>" placeholder="Enter Email">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="dob" name="dob" value="<?= $res->dob; ?>">
